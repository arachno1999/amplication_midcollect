...
export class GoodControllerBase {
  constructor(
  ...
  @swagger.ApiCreatedResponse({ type: Good })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Query() query: {},
    @common.Body() data: GoodCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Good] })
  ...
  async findOne(
    @common.Query() query: {},
    @common.Param() params: GoodWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<Good | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
