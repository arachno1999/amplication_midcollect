...
import { FindManyTypeArgs } from "./FindManyTypeArgs";
import { FindOneTypeArgs } from "./FindOneTypeArgs";
...
export class TypeResolver {
  ...
  async types(
    @graphql.Args() args: FindManyTypeArgs,
  ...
  async type(
    @graphql.Args() args: FindOneTypeArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ): Promise<Type | null> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
