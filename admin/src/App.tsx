...
import { GoodIndex } from "./good/GoodIndex";
import { TypeIndex } from "./type/TypeIndex";
      ...
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/goods" component={GoodIndex} />
            <PrivateRoute path="/types" component={TypeIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
